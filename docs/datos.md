...
<div class="vue-mount">
<csv-loader src="data/Publicaciones_Datos.csv" filter-col="tipo" category="Dataset">
    <script type="text/template">
        <div class="filters">
            <div class="filter-group">
                <input type="text" v-model="searchQuery" placeholder="Buscar datos o proyectos..." class="form-control" style="max-width: 300px; display: inline-block;">
                ...
                <tbody>
                    <tr v-for="item in items" :key="item.titulo">
                        <td>
                            ...
                            <span class="data-table__subtitle">{{ 'Proyecto: ' + item.proyecto }}</span>
                        </td>
                        <td>
                            <span class="component-chip">{{ item.revistaeditorial }}</span>
                        </td>
                        <td>{{ item.anio }}</td>
                        <td>
